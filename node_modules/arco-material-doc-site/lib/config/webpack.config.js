...
function getModuleRuleForCss(production) {
    return [
        {
            loader: production ? mini_css_extract_plugin_1.default.loader : 'style-loader',
        },
        {
            loader: 'css-loader',
        },
...
function getModuleRuleForLess({ cssModule, production, }) {
    return [
        {
            loader: production ? mini_css_extract_plugin_1.default.loader : 'style-loader',
        },
        ...
        plugins: [
            new plugin_1.default({
                globs: {
                    ...
                    demo: path_1.default.resolve(buildConfig.globs.component.base, buildConfig.globs.component.demo),
                },
            }),
        ...
        generateBaseConfig(),
        {
            ...
            plugins: [
                new mini_css_extract_plugin_1.default({
                    filename: `${generateEntryFiles_1.LIBRARY_MODULE_NAME}.css`,
                }),
            ],
            optimization: {
